  ...
  return (
    <Card>
      ...
      <CardFooter className="flex flex-row gap-2">
        <Button className="w-full rounded bg-black px-4 py-2 font-semibold text-white hover:bg-gray-700" onClick={() => navigation('/projects/project123')}>View Project</Button>
